	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<p>
				<strong>Instructions:</strong>
				<ol>
					<li>Register as a FiWare Service Provider at <a href='https://account.lab.fi-ware.org/' target="_blank">account.lab.fi-ware.org</a>.</li>
					<li>At FiWare, create a new App. This will enable your site to access the FiWare Enablers.</li>
					<li>At FiWare, provide your site's homepage URL (<?php echo $blog_url; ?>) for the new App's Redirect URI. Don't forget the trailing slash!</li>
					<li>Paste your OAuth2 credentials (App ID/Secret) provided by FiWare into the fields above, then click the Save all settings button.</li>
				</ol>
			</p>
			<?php submit_button('Save all settings'); ?>
			</div> <!-- .form-padding -->
